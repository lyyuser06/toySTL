...
template <typename Item>
Vector<Item>::Vector(int size, const Item &item, int capacity) :
...
template <typename Item>
typename Vector<Item>::Iterator Vector<Item>::begin() const { return Iterator(_elem); }

template <typename Item>
typename Vector<Item>::Iterator Vector<Item>::end() const { return Iterator(_elem + _size); }